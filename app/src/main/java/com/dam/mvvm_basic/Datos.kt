...
enum class EstadosBotones(val txt: String){
    BOTON_ROJO(txt = "Estado Rojo"),

    BOTON_VERDE(txt = "Estado Verde"),

    BOTON_AZUL(txt = "Estado Azul"),

    BOTON_AMARILLO(txt = "Estado Amarillo"),

    BOTON_CERO(txt = "Ningún botón presionado")
}
